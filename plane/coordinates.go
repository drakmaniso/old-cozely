...
// Homogen returns an homogenous coordinate vector corresponding to v, with Z
// set to 1.
...
// Polar is a pair of polar coordinates.
type Polar struct {
	R     float32 // Radius (i.e. distance from origin)
	Theta float32 // Angle //TODO: what angle?
}

// Cartesian returns the cartesian representation of v. It implements the Vector
// interface.
