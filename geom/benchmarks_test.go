...
func (m *Mat4) timesThreeRefs(a, b *Mat4) {
...
func (m Mat4) timesRecvValArgRef(o *Mat4) Mat4 {
	return Mat4{
		{
...
func (m *Mat4) timesRecvRefArgVal(o Mat4) Mat4 {
	return Mat4{
		{
			m[0][0]*o[0][0] + m[0][1]*o[1][0] + m[0][2]*o[2][0] + m[0][3]*o[3][0],
			m[0][0]*o[0][1] + m[0][1]*o[1][1] + m[0][2]*o[2][1] + m[0][3]*o[3][1],
...
func (m Mat4) timesRecvValArgVal(o Mat4) Mat4 {
	return Mat4{
		{
			m[0][0]*o[0][0] + m[0][1]*o[1][0] + m[0][2]*o[2][0] + m[0][3]*o[3][0],
			m[0][0]*o[0][1] + m[0][1]*o[1][1] + m[0][2]*o[2][1] + m[0][3]*o[3][1],
