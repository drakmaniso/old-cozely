...
func TestMat4_ZeroValue(t *testing.T) {
	var m geom.Mat4
...
func TestMat4_Literal(t *testing.T) {
	m := geom.Mat4{
		{1.1, 2.1, 3.1, 4.1},
		{1.2, 2.2, 3.2, 4.2},
		{1.3, 2.3, 3.3, 4.3},
...
func TestMat4_Allocation(t *testing.T) {
	m := &geom.Mat4{
		{1.1, 2.1, 3.1, 4.1},
		{1.2, 2.2, 3.2, 4.2},
		{1.3, 2.3, 3.3, 4.3},
...
func TestMat4_Assignment(t *testing.T) {
	var m geom.Mat4
	_ = m
	m = geom.Mat4{
		{1.1, 2.1, 3.1, 4.1},
...
func TestMat4_ArrayPadding(t *testing.T) {
	a := [2]geom.Mat4{
		{
			{1.1, 2.1, 3.1, 4.1},
			{1.2, 2.2, 3.2, 4.2},
