...
func (dp DefaultBuilder) Comment(txt string) error {
	return nil
}

func (dp DefaultBuilder) O(name string) error {
	return nil
}

func (dp DefaultBuilder) G(names ...string) error {
	return nil
}

func (dp DefaultBuilder) S(group int) error {
	return nil
}

func (dp DefaultBuilder) LOD(level int) error {
	return nil
}

func (dp DefaultBuilder) V(coords ...float32) error {
	return nil
}

func (dp DefaultBuilder) VT(coords ...float32) error {
	return nil
}

func (dp DefaultBuilder) VN(coords ...float32) error {
	return nil
}

func (dp DefaultBuilder) F(verts ...Indices) error {
	return nil
}

func (dp DefaultBuilder) P(verts ...Indices) error {
	return nil
}

func (dp DefaultBuilder) L(verts ...Indices) error {
	return nil
}

func (dp DefaultBuilder) MtlLib(name ...string) error {
	return nil
}

func (dp DefaultBuilder) UseMtl(name string) error {
	return nil
}

func (dp DefaultBuilder) MapLib(name ...string) error {
	return nil
}

func (dp DefaultBuilder) UseMap(name string) error {
	return nil
}

func (dp DefaultBuilder) NotSupported(txt string) error {
	return nil
}
