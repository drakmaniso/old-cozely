...
func Perlin3D(p coord.XYZ) float32 {
	...
	n000 := Gradient3D[g000].Dot(coord.XYZ{X: rx, Y: ry, Z: rz})
	n100 := Gradient3D[g100].Dot(coord.XYZ{X: rx - 1, Y: ry, Z: rz})
	n010 := Gradient3D[g010].Dot(coord.XYZ{X: rx, Y: ry - 1, Z: rz})
	n110 := Gradient3D[g110].Dot(coord.XYZ{X: rx - 1, Y: ry - 1, Z: rz})
	n001 := Gradient3D[g001].Dot(coord.XYZ{X: rx, Y: ry, Z: rz - 1})
	n101 := Gradient3D[g101].Dot(coord.XYZ{X: rx - 1, Y: ry, Z: rz - 1})
	n011 := Gradient3D[g011].Dot(coord.XYZ{X: rx, Y: ry - 1, Z: rz - 1})
	n111 := Gradient3D[g111].Dot(coord.XYZ{X: rx - 1, Y: ry - 1, Z: rz - 1})
