...
//
//   vec3 glam_ToneMap(vec3 Color);
func ToneMapReinhardt() gfx.PipelineConfig {
	return gfx.FragmentShader(strings.NewReader(tmReinhardt))
}
...
//
//   vec3 glam_ToneMap(vec3 Color);
func ToneMapHejl() gfx.PipelineConfig {
	return gfx.FragmentShader(strings.NewReader(tmHejl))
}
...
//
//   vec3 glam_ToneMap(vec3 Color);
func ToneMapHable() gfx.PipelineConfig {
	return gfx.FragmentShader(strings.NewReader(tmHable))
}
...
//
//   vec3 glam_ToneMap(vec3 Color);
func ToneMapSimpleACES() gfx.PipelineConfig {
	return gfx.FragmentShader(strings.NewReader(tmSimpleACES))
}
...
//
//   vec3 glam_ToneMap(vec3 Color);
func ToneMapACES() gfx.PipelineConfig {
	return gfx.FragmentShader(strings.NewReader(tmACES))
}
